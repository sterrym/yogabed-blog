...
?>
  ...
  <footer id="lower-footer" role="contentinfo">
    <div class="legal">
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-5 text-right"><a href="#top" class="return-to-top" title="Return to Top"><span class="fa fa-chevron-up glyphicon glyphicon-chevron-up  "></span></a></div>
        </div>
      </div>
    </div>
  </footer><!-- #colophon -->
